...
$entryExeName = "CrystalRelayTwitchOsc-v$Version-bugfix$BugFix.exe"
$stableTag = "v$Version"
...
# === Rename main executable to versioned name ===
...
if (-not (Test-Path $entryExePath)) {
    $errors += "Entry executable not found at $entryExePath"
}
