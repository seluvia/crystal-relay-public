...
static bool IsAllowedEnglishLiteral(string value) => value switch
{
    ...
    or "Are you sure you want to delete every avatar set and the redeems inside them? This cannot be undone."
    or "Are you sure you want to delete every avatar scale set and scale redeem? This cannot be undone."
    or "Are you sure you want to delete every Bits + Subs override? This cannot be undone."
    or "Are you sure you want to delete every cash payment rule? This cannot be undone. Provider connection settings and saved credentials are kept."
    or "Are you sure you want to delete every movement set and movement redeem? This cannot be undone."
    or "Are you sure you want to delete every universal trigger? This cannot be undone."
    ...
    or "Glitchy Random Height"
    or "Glitchy Random Height keeps changing height between Random Min Height and Random Max Height until Active Time ends."
    or "Maximum Height"
    ...
    or "Choose which VRChat movement input Crystal Relay should send for this rule. Random Movement rolls one direction per use. Glitchy Movement keeps rolling random directions until Active Time ends."
